...
const double kIconSizeLarge = 140.0;
const double kIconSizeMedium = 72.0;
const double kIconSizeSmall = 56.0;
const double kCardPadding = 24.0;
const double kSpacingStandard = 16.0;
const double kSpacingSmall = 8.0;
const double kForecastCardWidth = 110.0;
const double kForecastCardHeight = 140.0;
const double kHourlyForecastCardHeight = 150.0;
...
class WeatherPage extends StatelessWidget {
      ...
      builder: (context, cityName, child) {
        return Selector<WeatherProvider, String?>(
          ...
          builder: (context, condition, child) {
            ...
            final drawerGradientColors = gradientColors.map((c) => c.withAlpha(230)).toList();
            ...
            return FrostedPageScaffold(
              ...
              appBar: AppBar(
                ...
                actions: [
                  if (citySelector != null) citySelector!,
                  const SizedBox(width: 8),
                ],
              ),
              drawer: Selector<WeatherProvider, SDCity>(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          // NWS Alerts
                          Selector<WeatherProvider, List<NwsAlertFeature>>(
  ...
  Widget _buildDetailsCard(BuildContext context) {
    return Selector<WeatherProvider, WeatherData>(
      ...
      builder: (context, weatherData, child) {
        final conditions = weatherData.currentConditions!;
        // Note: sunrise/sunset data requires a different approach with the provider pattern.
        // This is a simplified version. For full accuracy, the API response containing
        // this data would need to be stored in the provider.
        final sunrise = weatherData.sunrise;
        final sunset = weatherData.sunset;
            ...
            final items = [
              ...
              [
                _buildDetailItem(
                  ...
                  'UV',
                  conditions.uvIndex != null ? conditions.uvIndex.toString() : 'N/A',
                ),
                _buildDetailItem(
                ...
                _buildDetailItem(
                  ...
                  'Sunrise',
                  sunrise != null ? _timeFormatter.format(sunrise) : 'N/A',
                ),
                _buildDetailItem(
                  const BoxedIcon(WeatherIcons.sunset, color: AppTheme.textLight, size: 28),
                  'Sunset',
                  sunset != null ? _timeFormatter.format(sunset) : 'N/A',
                ),
              ],
            ];
            return GlassCard(
        ...
        if (!hasRain) {
          return GlassCard(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  const Icon(Icons.water_drop_outlined, color: Colors.blueGrey, size: 22),
